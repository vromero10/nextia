...
// Next.js usa esto para pre-renderizar todas las páginas de posts de ciberseguridad
export async function generateStaticParams() {
  const posts = await getAllSecPosts()
  return posts.map(p => ({ slug: p.slug }))
}

// Componente principal de la página de post individual de ciberseguridad
